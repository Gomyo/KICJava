...
<div class="con_txt">
	<form action="./board" method="post" name="dfrm">
		...
		<div class="contents_sub">	
			...
			<div class="btn_area">
				<div class="align_left">
					...
					<input type="button" value="보기" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./board?action=view&seq=<%=seq%>'" />
				</div>
