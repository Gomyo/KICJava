...
<script type="text/javascript">
	window.onload = function() {
		...
		document.getElementById('wbtn').onclick = function() {
			...
			if (document.wfrm.upload.value.toLowerCase().endsWith('png') ||
					document.wfrm.upload.value.toLowerCase().endsWith('jpg') || 
					document.wfrm.upload.value.toLowerCase().endsWith('gif') ||
					document.wfrm.upload.value.toLowerCase().endsWith('jpeg') ||
	...
	<form action="write_ok.do" method="post" name="wfrm" enctype="multipart/form-data">
		...
		<!--게시판-->
			<div class="board_write">
				...
				<tr>
					<th class="top">글쓴이</th>
					<td class="top" colspan="3"><input type="text" name="writer" value="" class="board_write_input_100"/></td>
				</tr>
				<tr>
					<th>제목</th>
