...
<%
	...
	try {
		...
		String sql = "select subject, writer, substring_index(mail, '@', 1) mail1, substring_index(mail, '@', -1) mail2, wip, wdate, hit, content, password from board1 where seq=?";
		...
		if(rs.next()) {
			...
			if( rs.getString( "mail1" ).equals( "" ) && rs.getString( "mail2" ).equals( "" )) {
				mail1 = rs.getString("");
				mail2 = rs.getString("");
			} else {
...
<div class="con_txt">
	<form action="./board_modify1_ok.jsp" method="post" name="dfrm">
