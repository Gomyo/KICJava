...
<script type="text/javascript">
	window.onload = function() {
		document.getElementById('cbtn').onclick = function() {
			if(document.cfrm.writer.value.trim() == "") {
				alert('이름을 입력하셔야 합니다.');
				return false;				
			}
			if(document.cfrm.password.value.trim() == "") {
				alert('비밀번호를 입력하셔야 합니다.');
				return false;				
			}
			if(document.cfrm.content.value.trim() == "") {
				alert('내용을 입력하셔야 합니다.');
				return false;				
			}
		...
		<div class="board_view">
			...
			<tr>
				...
				<td align="right" class="bg01">
					<input type="button" value="댓글등록" id="cbtn" class="btn_comment_write btn_txt01" />
				</td>
			</tr>
			</table>
			</form>
